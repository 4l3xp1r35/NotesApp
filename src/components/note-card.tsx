    ...
    return (
      <Dialog.Root>
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className=' group fixed overflow-hidden left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[640px] w-full h-[60vh] bg-slate-700 rounded-md flex flex-col outline-none'>
            <Dialog.Close className=" group-focus-visible:ring-2 group-focus-visible:ring-lime-400 absolute right-0 top-0 bg-slate-800 p-1.5 text-slate-400 hover:text-slate-100" >
              <X className="size-5" />
            </Dialog.Close>
